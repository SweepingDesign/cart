...
use Leaphly\Cart\Form\Factory\FactoryInterface;
use Leaphly\Cart\Model\CartInterface;
use Leaphly\Cart\Model\CartManagerInterface;
...
{
    /**
     * @var \Leaphly\Cart\Model\CartManagerInterface
     */
    private $cartManager;

    /**
     * @var \Leaphly\Cart\Form\Factory\FactoryInterface
     */
    private $formFactory;
    ...
    /**
     * @var \Leaphly\Cart\Event\CartEventFactory
     */
